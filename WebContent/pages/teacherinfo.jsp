...
<div style="text-align: center;">
   <form method="get" action="http://localhost:8081/ssm/admin/searchteacher">
   	教职工号:
   	<input class="inp" type="text" name="teacherid" id="teacherid"  required="required">
...
<div class="table-wrapper">
    <table class="fl-table">
   	...
   	<c:forEach items="${teacherInfos }" var="item">
   	<tr>
   		...
   		<td>${item.address }</td>
   		<td>
		<form method="get" action="http://localhost:8081/ssm/admin/showteacher">
   			<input type="hidden" name="teacherid" id="teacherid" value=${item.teacherid }>
   			<input type="submit" class="btn btn-default" value="修改信息">
   		</form>
		</td>
		<td>
		<form method="get" action="http://localhost:8081/ssm/admin/deleteteacher">
   			<input type="hidden" name="teacherid" id="teacherid" value=${item.teacherid }>
   			<input type="submit" class="btn btn-default" value="删除记录">
   		</form>
		</td>
   	</tr>
   	</c:forEach>
   	<tr>
   		...
   		<td>
   		  <br>
   		  <form method="get" action="http://localhost:8081/ssm/admin/addteacherpage">
