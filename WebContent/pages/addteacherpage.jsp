...
<form name="myForm" method="get" action="http://localhost:8081/ssm/admin/addteacher" onsubmit="return validateForm();">
	<input type="text" name="teacherid" id="teacherid" required="required"  placeholder="教职工号"><br><br>
	<input type="text" name="teachername" id="teachername"required="required" placeholder="姓名"><br><br>
	<input type="text" name="gender" id="gender" required="required" placeholder="性别"><br><br>
	<input type="text" name="email" id="email" required="required" placeholder="邮箱"><br><br>
	<input type="text" name="phone" id="phone" required="required" placeholder="电话"><br><br>
	<input type="text" name="department" id="department" required="required" placeholder="部门"><br><br>
	<input type="text" name="address" id="address" required="required" placeholder="地址"><br><br>
