...
<div style="text-align: center;">
   <form method="get" action="http://localhost:8081/ssm/admin/searchcourse">
   	课程编号:
   	<input class="inp" type="text" name="courseid" id="courseid" required="required">
...
<div class="table-wrapper">
   <table class="fl-table">
	...
	<c:forEach items="${courseInfos }" var="item">
   	<tr>
   		<td>${item.courseid }</td>
   		...
   		<td>${item.jieci }</td>
   		<td>
		<form method="get" action="http://localhost:8081/ssm/admin/showcourse">
   			<input type="hidden" name="courseid" id="courseid" value=${item.courseid }>
   			<input type="submit" class="btn btn-default" value="修改信息">
   		</form>
		</td>
		<td>
		<form method="get" action="http://localhost:8081/ssm/admin/deletecourse">
   			<input type="hidden" name="courseid" id="courseid" value=${item.courseid }>
   	...
   	<tr>
   		...
   		<td>
   		  <br>
   		  <form method="get" action="http://localhost:8081/ssm/admin/addcoursepage">
