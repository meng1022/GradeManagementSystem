...
<div style="text-align: center;">
	<form method="get" action="http://localhost:8081/ssm/teacher/addscore">
   		 <input type="text" name="courseid" id="courseid" placeholder="课程序号" required="required"><br><br>
   		 <input type="text" name="studentid" id="studentid" placeholder="学生序号" required="required"><br><br>
		 <input type="text" name="score" id="score" placeholder="课程分数" ><br><br>
