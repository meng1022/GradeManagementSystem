...
<div style="text-align: center;">
   <form method="get" action="http://localhost:8081/ssm/admin/searchstudent">
   	学号:
   	<input class="inp" type="text" name="studentid" id="studentid" required="required">
...
<div class="table-wrapper">   
   <table class="fl-table">
   	...
   	<c:forEach items="${studentInfos }" var="item">
   	<tr>
   		...
   		<td>${item.classno }</td>
   		<td>
   		<form method="get" action="http://localhost:8081/ssm/admin/showstudent">
   			<input type="hidden" name="studentid" id="studentid" value=${item.studentid }>
   			<input type="submit" class="btn btn-default" value="修改信息">
   		</form>
   		</td>
   		<td>
   		<form method="get" action="http://localhost:8081/ssm/admin/deletestudent">
   			<input type="hidden" name="studentid" id="studentid" value=${item.studentid }>
   	...
   	<tr>
   		...
   		<td>
   		  <br>
   		  <form method="get" action="http://localhost:8081/ssm/admin/addstudentpage">
