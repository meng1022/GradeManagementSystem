...
<form name="myForm" method="get" action="http://localhost:8081/ssm/admin/addcourse" >
   	<input type="text" name="courseid" id="courseid" required="required" placeholder="课程序号"><br><br>
	<input type="text" name="coursename" id="coursename"  required="required" placeholder="课程名称"><br><br>
  	<input type="text" name="teacherid" id="teacherid" required="required" placeholder="授课教师教职工号"><br><br>
  	<input type="text" name="courseplace" id="courseplace" required="required" placeholder="地点"><br><br>
  	<input type="text" name="weektime" id="weektime" required="required" placeholder="周次"><br><br>
  	<input type="text" name="day" id="day"  required="required" placeholder="星期"><br><br>
  	<input type="text" name="jieci" id="jieci" required="required" placeholder="节次"><br><br>
  	<button type="submit" class="btn btn-default" >确认添加</button><br><br>
</form>
</div>
</body>
</html>